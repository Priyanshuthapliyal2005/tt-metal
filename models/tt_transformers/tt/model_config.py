    ...
    def accuracy(cls, model_name):
        ...
        if base_model_name in ["Llama-3.1-70B", "Llama-3.2-90B", "DeepSeek-R1-Distill-Llama-70B", "Qwen2.5-72B"]:
            ...
            if (
                ...
                or base_model_name.startswith("Ministral-8B")
            ):
                logger.info(
                ...
                if model_name.startswith("Ministral-8B"):  # TODO: Only do this for N150
                    logger.info(
...
class ModelArgs:
    ...
    def __init__(
        ...
        if HF_MODEL:
            ...
            if self.base_model_name in ["Ministral-8B-Instruct-2410"]:
        ...
        if max_prefill_chunk_size_div1024 is None:
            ...
            MAX_PREFILL_CHUNK_SIZES_DIV1024 = {
                ...
                "Ministral-8B-Instruct-2410": {"N150": 32, "N300": 64, "T3K": 128, "TG": 128, "P150x4": 128},
            }
            try:
            ...
            try:
                ...
                if not fallback_tokenizer_path:
                    ...
                    if "qwen2.5" in model_name_lower and "0.5b" in model_name_lower:
                        ...
                        "mistral-8b" in model_name_lower
                        and "instruct" in model_name_lower
                        and "2410" in model_name_lower
                    ):
                        fallback_tokenizer_path = "mistralai/Ministral-8B-Instruct-2410"
