...
# Import TTNN compatibility layer
import ttnn_compat
...
def load_ministral_model_and_tokenizer(device_id=0, batch_size=1, max_seq_len=512, instruct=True):
    ...
    try:
        ...
        try:
            device = ttnn_compat.init_tt_metal(device_id=device_id)
...
def cleanup_tt_resources():
    ...
    try:
        # Get the default device for cleanup
        device = ttnn_compat.get_default_device()
