...
class TtModelArgs:
    """Model args for Ministral 8B as provided by the params.json config file"""
    ...
    # Default folder location for weights and cached files for Ministral-8B-Instruct-2410
    DEFAULT_CKPT_DIR = os.getenv("MINISTRAL_CKPT_DIR", "/mnt/MLPerf/tt_dnn-models/Mistral/ministral-8b-instruct-2410/")
    DEFAULT_TOKENIZER_PATH = os.getenv("MINISTRAL_TOKENIZER_PATH", "/mnt/MLPerf/tt_dnn-models/Mistral/ministral-8b-instruct-2410/")
    DEFAULT_CACHE_PATH = os.getenv("MINISTRAL_CACHE_PATH", "/mnt/MLPerf/tt_dnn-models/Mistral/ministral-8b-instruct-2410/")
    ...
    def __init__(self, device, instruct=False):
        ...
        if not is_koyeb:
            ...
            ), f"Checkpoint directory {self.DEFAULT_CKPT_DIR} does not exist, please use export MINISTRAL_CKPT_DIR=..."
            assert os.path.isfile(
                self.DEFAULT_TOKENIZER_PATH + "/tokenizer.model"
            ), f"Tokenizer file {self.DEFAULT_TOKENIZER_PATH + '/tokenizer.model'} does not exist, please use export MINISTRAL_TOKENIZER_PATH=..."
            assert os.path.exists(
                self.DEFAULT_CACHE_PATH
            ), f"Cache directory {self.DEFAULT_CACHE_PATH} does not exist, please use export MINISTRAL_CACHE_PATH=..."
